...
public class healthy extends AppCompatActivity {
    ...
    private String diseaseLibraryID = "-ODPVGqxfkookDvAv6r3"; // Directly set your specific ID
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_healthy); // Change to your activity layout
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(healthy.this, "No data found for the disease library.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(healthy.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveData() {
        ...
        databaseReference.child("orgTreat").setValue(org)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(healthy.this, "Data updated successfully", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(healthy.this, "Failed to update data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
}
