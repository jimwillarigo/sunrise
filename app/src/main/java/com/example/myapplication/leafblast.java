...
public class leafblast extends AppCompatActivity {
    ...
    private String diseaseLibraryID = "-ODPV7pno9cbj5JNRNrg"; // Directly set your specific ID
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leafblast); // Change to your activity layout
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(leafblast.this, "No data found for the disease library.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(leafblast.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveData() {
        ...
        databaseReference.child("orgTreat").setValue(org)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(leafblast.this, "Data updated successfully", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(leafblast.this, "Failed to update data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
}
