...
public class stemborer extends AppCompatActivity {
    ...
    private String diseaseLibraryID = "-ODPVKi0pb6H8AycMbl5"; // Directly set your specific ID
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stemborer); // Change to your activity layout
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(stemborer.this, "No data found for the disease library.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(stemborer.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveData() {
        ...
        databaseReference.child("orgTreat").setValue(org)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(stemborer.this, "Data updated successfully", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(stemborer.this, "Failed to update data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
}
