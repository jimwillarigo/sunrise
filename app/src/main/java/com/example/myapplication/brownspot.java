...
public class brownspot extends AppCompatActivity {
    ...
    private String diseaseLibraryID = "-ODPV4lKiuciow85qXDM"; // Directly set your specific ID
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_brownspot); // Change to your activity layout
        ...
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Toast.makeText(brownspot.this, "No data found for the disease library.", Toast.LENGTH_SHORT).show();
                }
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(brownspot.this, "Database error: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void saveData() {
        ...
        databaseReference.child("orgTreat").setValue(org)
                .addOnSuccessListener(aVoid -> {
                    Toast.makeText(brownspot.this, "Data updated successfully", Toast.LENGTH_SHORT).show();
                })
                .addOnFailureListener(e -> {
                    Toast.makeText(brownspot.this, "Failed to update data: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                });
    }
}
