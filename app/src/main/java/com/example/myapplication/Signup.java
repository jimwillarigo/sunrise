            ...
            public void onClick(View v) {
                ...
                if (name.isEmpty() || username.isEmpty() || password.isEmpty()) {
                    ...
                    if (encryptedPassword != null) {
                                ...
                                .addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        if (dataSnapshot.exists()) {
                                            ...
                                            Toast.makeText(Signup.this, "Username already exists in the pending users list", Toast.LENGTH_SHORT).show();
                                        } else {
                                                            ...
                                                            if (dataSnapshot.exists()) {
                                                                ...
                                                                reference.child(uniqueId).setValue(helperClass)
                                                                        .addOnSuccessListener(aVoid -> {
                                                                            Toast.makeText(Signup.this, "Account under review, please wait for approval", Toast.LENGTH_SHORT).show();
                        ...
                        Toast.makeText(Signup.this, "Password encryption failed", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
